...
`Table.ResizeHandle` renders a visual handle you can wire up to your own column resizing logic.
...
Draggable-looking handle for column resizing. Wire it to TanStack Table or custom resize logic.
