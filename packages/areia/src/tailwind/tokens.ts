...
export const lightVariables = {
  /* surfaces */
  "--areia-background": "var(--color-white, #fff)",
  "--areia-foreground": "var(--color-neutral-900, oklch(21% 0.006 285.885))",
  "--areia-surface": "var(--color-white, #fff)",
...
export const darkVariables = {
  ...
  "--areia-foreground": "var(--color-neutral-100, oklch(97% 0 0))",
  "--areia-surface": "oklch(17% 0 0)",
  "--areia-surface-foreground": "var(--color-neutral-100, oklch(97% 0 0))",
  "--areia-surface-muted": "var(--color-neutral-800, oklch(26.9% 0 0))",
  "--areia-surface-muted-foreground": "var(--color-neutral-400, oklch(70.8% 0 0))",
  "--areia-surface-elevated": "oklch(20% 0 0)",
  "--areia-surface-elevated-foreground": "var(--color-neutral-50, oklch(98.5% 0 0))",
  "--areia-overlay": "oklch(0% 0 0 / 0.65)",
  "--areia-border": "var(--color-neutral-800, oklch(26.9% 0 0))",
  "--areia-input": "var(--color-neutral-900, oklch(21% 0.006 285.885))",
  "--areia-ring": "var(--areia-primary)",
  "--areia-divider": "var(--color-neutral-800, oklch(26.9% 0 0))",

  "--areia-text-default": "var(--color-neutral-100, oklch(97% 0 0))",
  "--areia-text-strong": "var(--color-neutral-50, oklch(98.5% 0 0))",
  "--areia-text-subtle": "var(--color-neutral-400, oklch(70.8% 0 0))",
  "--areia-text-muted": "var(--color-neutral-500, oklch(55.6% 0 0))",
  "--areia-text-placeholder": "var(--color-neutral-500, oklch(55.6% 0 0))",
  ...
  "--areia-badge-teal": "var(--color-teal-700, oklch(51.1% 0.096 186.391))",
  "--areia-badge-teal-soft": "var(--color-teal-900, oklch(38.6% 0.063 188.416))",
  "--areia-badge-teal-soft-foreground": "var(--color-teal-200, oklch(91% 0.096 180.426))",

  "--areia-success": "var(--color-green-900, oklch(39.3% 0.095 152.535))",
  "--areia-success-soft": "var(--color-emerald-900, oklch(37.8% 0.077 168.94))",
  "--areia-success-soft-foreground": "var(--color-emerald-200, oklch(90.5% 0.093 164.15))",
  "--areia-info": "var(--color-blue-900, oklch(37.9% 0.146 265.522))",
  "--areia-info-soft": "var(--color-blue-900, oklch(37.9% 0.146 265.522))",
  "--areia-info-soft-foreground": "var(--color-blue-400, oklch(70.7% 0.165 254.624))",
  "--areia-warning": "var(--color-yellow-900, oklch(42.1% 0.095 57.708))",
  "--areia-warning-soft": "var(--color-yellow-700, oklch(55.4% 0.135 66.442))",
  "--areia-warning-soft-foreground": "var(--color-yellow-400, oklch(85.2% 0.199 91.936))",
  "--areia-destructive": "var(--color-red-900, oklch(39.6% 0.141 25.723))",
  "--areia-destructive-soft": "var(--color-red-900, oklch(39.6% 0.141 25.723))",
  "--areia-destructive-soft-foreground": "var(--color-red-400, oklch(70.4% 0.191 22.216))",

  "--areia-control-background": "var(--areia-surface)",
  "--areia-control-foreground": "var(--areia-text-default)",
  "--areia-control-border": "var(--areia-border)",
  "--areia-control-hover": "var(--areia-surface-muted)",
  "--areia-control-active": "var(--color-neutral-700, oklch(37.1% 0 0))",
