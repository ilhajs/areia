...
export const Demo1 = ilha(() => <Slider class="w-full max-w-sm" defaultValue={50} max={100} />);

export const Demo2 = ilha(() => <Slider class="w-full max-w-sm" defaultValue={50} max={100} />);
