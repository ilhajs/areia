...
export const Demo2 = ilha(() => <Button variant="secondary">Click me</Button>);

export const Demo3 = ilha(() => <Button variant="primary">Primary</Button>);

export const Demo4 = ilha(() => <Button variant="secondary">Secondary</Button>);

export const Demo5 = ilha(() => <Button variant="ghost">Ghost</Button>);

export const Demo6 = ilha(() => <Button variant="destructive">Destructive</Button>);

export const Demo7 = ilha(() => <Button variant="outline">Outline</Button>);
